...
def Random_proj(img1, img2, crop_size=480, ratio=0.2, scale=0.2, rotation=10):
    half_cs = crop_size // 2
    if len(img1.shape) < 4:
    ...
    img2_crop = img2_warped[:, :, c1[0, 1, 0] - half_cs:c1[0, 1, 0] + half_cs,
                c1[0, 0, 0] - half_cs:c1[0, 0, 0] + half_cs]
